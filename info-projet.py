            ...
            if p['x']== 3 and p['y'] ==3:
                if a==0:
                   ...
                   break
                    ...
                    if p["objet"]==1 and b==0:
                    	print(r,":Les escaliers sont trop fragile avec le feu, vaut mieux enlever l'extincteurs à chaque fois")
                    	b=b+1
                    if p["objet"]>1 and b==0:
                        print(r,":Les escaliers sont trop fragile avec le feu, vaut mieux enlever les extincteurs à chaque fois.")
                        b=b+1
                    c=randint(0,4)
                    if c==1:
                    	print (r,":Aller, je suis à l'étage",a,"\n",r,":Je dois faire vite")
                    a=a-1
                    break
...
display_map_char_and_objects(6,6,(1,1))from random import randint
import time
def genereMat(n,m):
    MAT=[[0 for j in range(m)]for i in range(n)]
    for a in range(0,2):
